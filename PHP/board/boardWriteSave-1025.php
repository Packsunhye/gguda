    ...
    if($boardImgFile){
        ...
        if($fileType == "image"){
            if($fileExtension == "jpg" || $fileExtension == "jpeg" || $fileExtension == "png" || $fileExtension == "gif"){
                ...
                echo "이미지 파일이 맞네요!";
                $sql = "INSERT INTO myBoard(myMemberID, boardTitle, boardSection, boardContents, boardImgFile, boardImgSize, boardView, regTime) VALUES('$myMemberID', '$boardTitle', '$boardSection', '$boardContents', '$boardImgFile', '$boardImgSize', '$boardView', '$regTime')";
            } else {
